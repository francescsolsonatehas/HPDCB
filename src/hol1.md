...
This website you are using right now is also hosted on Github Pages, you may have noticed already noticed given the URL is [https://hdbc-17705110-mdbs.github.io/HandsOnLabs/](https://hdbc-17705110-mdbs.github.io/HandsOnLabs/). If you take a look at the about page of the website (which is also the home page), you'll see that there is a list of all websites the students have created, I want you to share your own website there by following the steps below:
